...
const officeSprite = (sx, sy, sw = 48, sh = 48) => ({
  image: "office",
  sx,
  sy,
  sw,
...
const tilePatch = (id, x, y, width, height, sprite) => ({
  id,
  position: { x, y },
  size: { width, height },
  sprite
...
const evidenceItems = [
  {
    ...
    summary: "New hires say they receive multiple versions of the same onboarding instructions from different people.",
  ...
  },
  {
    ...
    summary: "The process map has three handoffs before tool access is confirmed.",
  ...
  },
  {
    ...
    summary: "Support tickets spike during weeks two and three, after formal orientation ends.",
  ...
  },
  {
    ...
    summary: "Reps answer product questions clearly, but only 34% ask a second-layer discovery question before moving into the demo.",
...
const diagnosisOptions = [
  {
    id: "more-elearning",
    caseId: "onboarding",
    label: "Improve orientation with clearer role examples and a stronger knowledge check.",
    explanation: "This is tempting because the leader asked for training and the course can probably be improved. It still treats the problem as a content gap while the evidence points to handoffs, access, and manager follow-up.",
    correct: false,
    consequence: "You would ship something visible, but new hires could still receive mixed instructions, wait on access, and need support after orientation ends.",
    evidenceHint: "The evidence shows conflicting instructions, delayed access, and week-two support tickets. None of those are solved by a knowledge check alone.",
    learningTakeaway: "Do not label a problem as training until the evidence shows people lack knowledge or skill."
  },
  {
    id: "workflow-reinforcement",
    caseId: "onboarding",
    label: "Standardize the handoffs and give managers follow-up checkpoints.",
    explanation: "Correct. This explains the full pattern: inconsistent instructions, delayed access, and weak support after orientation.",
    correct: true,
    consequence: "The solution space opens beyond training: clarify ownership, reinforce manager behavior, and track ramp signals.",
    evidenceHint: "Interview notes, process handoffs, and week-two tickets all point to workflow plus reinforcement.",
    learningTakeaway: "A strong diagnosis explains the whole work system: process, manager behavior, tools, and follow-up."
  },
  {
    id: "software-broken",
    caseId: "onboarding",
    label: "Escalate tool access as the main issue because new hires are blocked too long.",
    explanation: "This is a smart partial read because access delay is real. It fails as the main diagnosis because the evidence also shows mixed expectations and weak follow-up after access is granted.",
    correct: false,
    consequence: "You would improve one bottleneck, but managers could still give inconsistent expectations and new hires could still need help in weeks two and three.",
    evidenceHint: "Access delay matters, but it does not explain the conflicting instructions or the support-ticket spike by itself.",
    learningTakeaway: "A contributing factor is not always the root cause. Look for the pattern that explains the full case."
  },
  {
    id: "sales-product-training",
    caseId: "sales",
    label: "Atlas Pro is underperforming because reps need more product knowledge.",
    explanation: "This is tempting because leaders asked for training and Atlas Pro is more complex. But the call review shows reps can explain features; the bigger gap is business discovery and value connection.",
    correct: false,
    consequence: "Reps might sound more polished, but shallow discovery and weak next-step conversion would likely remain.",
    evidenceHint: "Feature explanation is not the weak signal; discovery depth and next-step conversion are.",
    learningTakeaway: "Sales enablement should target the behavior that changes pipeline outcomes, not just product knowledge."
  },
  {
    ...
    evidenceHint: "The deck, guide, calls, dashboard, CRM notes, and coaching archive triangulate the same behavior gap.",
    learningTakeaway: "When multiple evidence items point to the same sales behavior, design for practice, coaching, and inspection."
  },
  {
    id: "sales-more-activity",
    caseId: "sales",
    label: "Atlas Pro is losing because the demo deck needs a sharper value story.",
    explanation: "This is plausible because messaging can improve demos. It still misses the evidence that reps are not uncovering buyer pain before the story begins.",
    correct: false,
    consequence: "A better deck could support reps, but it would not create deeper discovery, manager coaching, or a pipeline inspection habit.",
    evidenceHint: "The pipeline signal points to behavior before and after the demo, not only the deck used during it.",
    learningTakeaway: "Content may support the solution, but it rarely replaces behavior change and manager reinforcement."
  },
  {
    id: "sales-price-pressure",
    caseId: "sales",
    label: "Atlas Pro is losing mainly because the product is priced too high for the market.",
    explanation: "Price appears in the CRM, so this is a plausible business concern. It is still too narrow because pain-linked opportunities convert better and managers are not coaching the behavior consistently.",
    correct: false,
    consequence: "You would hand off the problem too early and miss the sales behaviors Enablement can influence.",
    evidenceHint: "The CRM data includes price, but the call review, discovery guide, and coaching archive point to controllable sales behavior.",
    learningTakeaway: "Enablement should name cross-functional factors without ignoring the behavior it can improve."
  }
];
const interventionOptions = [
  {
    id: "training-module",
    caseId: "onboarding",
    label: "Publish a cleaner onboarding course and require completion by week one.",
    explanation: "This is easy to approve because it is familiar and trackable. It does not fix ownership, access timing, or manager follow-through.",
    correct: false,
    consequence: "Completion could rise while ramp time and week-two support tickets stay stubborn.",
    tradeoff: "Fast to ship, but it leaves managers and access handoffs untouched.",
    learningTakeaway: "A course is useful only when the root cause is knowledge or skill. This case needs work-system support."
  },
  {
    id: "diagnostic-canvas",
    caseId: "onboarding",
    label: "Create a handoff checklist, manager job aid, and ramp dashboard.",
    explanation: "Correct. This supports the workflow, reinforces expectations, and creates visible measures leaders can inspect after launch.",
    correct: true,
    consequence: "Managers get a repeatable operating habit, new hires get clearer support, and leaders can inspect ramp health.",
    tradeoff: "Requires manager adoption, but it addresses workflow, reinforcement, and measurement together.",
    learningTakeaway: "The best enablement solution changes the workflow and gives leaders a signal they can inspect."
  },
  {
    id: "announcement",
    caseId: "onboarding",
    label: "Send a leader-backed process update and ask teams to follow it immediately.",
    explanation: "Communication is useful, and leaders often reach for it first. But one announcement does not create a repeatable handoff or manager follow-up habit.",
    correct: false,
    consequence: "People may know the official process for a week, but old handoff habits can return quickly.",
    tradeoff: "Low effort, low behavior change. It does not create a new operating habit.",
    learningTakeaway: "Awareness is not adoption. Sustainable enablement needs reinforcement in the flow of work."
  },
  {
    id: "sales-demo-certification",
    caseId: "sales",
    label: "Require every rep to retake Atlas Pro product training and pass demo certification.",
    explanation: "Certification feels rigorous, but it mostly tests presentation. The evidence points to discovery and manager reinforcement before and after the demo.",
    correct: false,
    consequence: "Reps may pass a presentation test while still failing to uncover buyer pain before the demo.",
    tradeoff: "It measures presentation skill more than buyer diagnosis or pipeline behavior.",
    learningTakeaway: "Certification can validate a skill, but it should not distract from the behavior blocking revenue."
  },
  {
    ...
    learningTakeaway: "Sales enablement is strongest when rep practice, manager coaching, and pipeline measurement reinforce each other."
  },
  {
    id: "sales-slack-reminder",
    caseId: "sales",
    label: "Send weekly discovery tips and sample questions after every pipeline call.",
    explanation: "Tips can reinforce a habit, and they are cheap to send. Alone, they do not give reps practice, manager coaching, or measurement.",
    correct: false,
    consequence: "The team receives helpful reminders, but there is no reliable practice loop or manager accountability.",
    tradeoff: "Useful as a support tactic, weak as the core intervention.",
    learningTakeaway: "Tips can support behavior change, but they do not create practice, coaching, or accountability by themselves."
  },
  {
    id: "sales-deck-only",
    caseId: "sales",
    label: "Redesign the Atlas Pro deck and ask reps to use the new version immediately.",
    explanation: "The deck should improve, but a deck-only fix does not create discovery practice, manager coaching, CRM inspection, or measurement.",
    correct: false,
    consequence: "Reps may have cleaner slides while the underlying qualification and coaching habits stay weak.",
    tradeoff: "Useful supporting artifact, but too narrow as the main intervention.",
    learningTakeaway: "A good artifact helps the system; it does not replace the system."
  }
];
const earnedCanvas = {
  ...
  learnerDebrief: {
    ...
    points: [
      {
        label: "Diagnose",
        value: "You tested the training request against evidence from people, process, tools, and follow-up."
      },
      {
        label: "Design",
        value: "You chose support that changes the work: checklist, job aid, handoff map, and dashboard."
      },
      {
        label: "Measure",
        value: "You connected the fix to ramp time, support tickets, and confidence."
      }
    ]
  },
  sections: [
    ...
    {
      label: "Root Cause",
      value: "Unclear onboarding workflow, delayed tool access, and inconsistent manager reinforcement."
    },
    {
      label: "Intervention",
      value: "Manager checklist, new-hire job aid, access handoff map, and lightweight diagnostic dashboard."
    },
    {
      label: "Accessibility / Inclusion",
      value: "Use plain language, keyboard-accessible artifacts, readable contrast, and one source of truth."
    },
    {
      label: "Responsible AI Support",
      value: "Use AI to summarize interviews and draft job aids, with human review before publishing."
    },
    {
      label: "Expected Impact",
      value: "Time to productivity improves from 90 to 65 days; support tickets decrease 22%; confidence increases."
    }
  ]
};
const salesCanvas = {
  ...
  learnerDebrief: {
    ...
    points: [
      {
        label: "Diagnose",
        value: "You separated the training request from the actual performance pattern behind the win-rate gap."
      },
      {
        label: "Design",
      ...
      {
        label: "Measure",
        value: "You tied enablement work to discovery quality, proposal conversion, manager coaching, and win-rate movement."
      }
    ]
  },
  sections: [
    {
      label: "Business Problem",
      value: "Atlas Pro opportunities are reaching proposal, but completed deals are closing at about 23.6% instead of the expected 30%."
    },
    {
      label: "Root Cause",
    ...
    {
      label: "Intervention",
      value: "Discovery practice loop, value-framing guide, manager coaching rubric, call-review practice, and pipeline inspection dashboard."
    },
    {
      label: "Accessibility / Inclusion",
      value: "Use plain-language prompts, accessible templates, role-play options, and clear examples for varied experience levels."
    },
    {
      label: "Responsible AI Support",
      value: "Use AI to summarize call patterns, cluster CRM notes, and draft coaching prompts, with sales leader review before use."
    },
    {
      label: "Expected Impact",
...
function getCamera(viewport, scene, gameState) {
...
function drawSceneBase(ctx, viewport, scene, camera, assets) {
  ...
  const floorSprite = scene.floorSprite ?? (scene.theme === "exterior" ? tileSprites.grass : scene.id === "operations" ? tileSprites.warmFloor : tileSprites.labFloor);
...
function drawTilePatches(ctx, scene, camera, assets) {
...
function drawExteriorLandmarks(ctx, scene, camera) {
  if (scene.id !== "hub") {
    return;
  }
  const buildings = [
...
function drawCampusPlanting(ctx, camera) {
  const shrubs = [
    { x: 4.4, y: 8.15 },
    { x: 9.2, y: 8.15 },
    { x: 20.1, y: 8.15 },
...
function drawCampusBuilding(ctx, x, y, width, height, fill, accent, label) {
  ctx.save();
  ...
  for (let index2 = 0; index2 < 3; index2 += 1) {
    const windowX = x + width * (0.2 + index2 * 0.27);
...
function drawCampusDoor(ctx, x, y, width, height, accent) {
  ctx.save();
...
function drawCampusFountain(ctx, x, y) {
  ctx.save();
  ...
  for (let index2 = 0; index2 < 3; index2 += 1) {
    ctx.beginPath();
    ctx.arc(x, y - 4, 14 + index2 * 12, Math.PI * 1.05, Math.PI * 1.95);
    ctx.stroke();
  }
...
function drawCampusPlaque(ctx, text, x, y) {
  ctx.save();
...
function drawInteriorLandmarks(ctx, scene, camera) {
  if (scene.id !== "operations" && scene.id !== "sales") {
    return;
  }
  const theme = scene.id === "operations" ? {
    accent: "#f59e0b",
...
function drawInteriorHeader(ctx, scene, camera, title, accent) {
...
function drawLearningZone(ctx, camera, rect, fill, accent) {
...
function drawExitGuide(ctx, scene, camera, accent) {
  const x = scene.width * TILE_SIZE * 0.5 - camera.x;
...
function drawRoomBorders(ctx, scene, camera, assets) {
...
function drawInteriorPortalHotspot(ctx, x, y, width, height, label) {
...
function drawPortalHotspot(ctx, x, y, width, height, label) {
...
function shortPortalLabel(label) {
...
function drawEvidence(ctx, scene, gameState, camera, assets) {
  ...
  const expectedEvidence = evidenceItems.find(
    (item) => item.caseId === gameState.currentCaseId && !gameState.collectedEvidenceIds.includes(item.id)
  );
  for (const evidence of visibleEvidence) {
    ...
    const evidenceIndex = evidenceItems.filter((item) => item.caseId === gameState.currentCaseId).findIndex((item) => item.id === evidence.id) + 1;
    const isExpected = evidence.id === (expectedEvidence == null ? void 0 : expectedEvidence.id);
    const stationX = x - 13;
    const stationY = y + 17;
    ...
    ctx.strokeStyle = isExpected ? "rgba(250, 204, 21, 0.72)" : "rgba(148, 163, 184, 0.38)";
    ctx.lineWidth = 2;
...
function drawCharacters(ctx, scene, gameState, camera, assets) {
  ...
  for (const character of sceneCharacters) {
    ...
    const direction = (characterState == null ? void 0 : characterState.direction) ?? "down";
...
function drawPlayer(ctx, gameState, camera, assets) {
  const x = gameState.player.position.x * TILE_SIZE - camera.x - PLAYER_WIDTH / 2;
  const y = gameState.player.position.y * TILE_SIZE - camera.y - PLAYER_HEIGHT + 18;
  ...
  const sprite = gameState.player.isMoving ? {
    image: "adamRun",
...
function useGameLoop({
  ...
  const setToast = reactExports.useCallback(
    (message) => {
  ...
  const collectNearbyEvidence = reactExports.useCallback(() => {
    const state = gameStateRef.current;
    const nearby = evidenceItems.find((item) => {
      if (item.sceneId !== state.player.sceneId || item.caseId !== state.currentCaseId || state.collectedEvidenceIds.includes(item.id)) {
        return false;
      }
      return distanceInPixels(state.player.position, item.position) < INTERACT_DISTANCE;
    });
    if (!nearby) {
      return false;
    }
    ...
    setGameState((previous) => {
      ...
      const allCollected = caseEvidence.every(
        (item) => collectedEvidenceIds.includes(item.id)
      );
      return {
        ...previous,
  ...
  const openNearbyCharacter = reactExports.useCallback(() => {
    const state = gameStateRef.current;
  ...
  const interact = reactExports.useCallback(() => {
    ...
    if ((state.questStage === "diagnose" || state.questStage === "design") && getNearbyCaseOwner(state)) {
      setGameState((previous) => ({
        ...previous,
        overlay: "decision",
        toast: null
  ...
  const tick = reactExports.useCallback(
    (timestamp) => {
      ...
      if (state.player.hasStarted && state.overlay === "none") {
        ...
        } else if (state.player.isMoving || ambientState.characterStates !== state.characterStates) {
          const nextState = {
            ...ambientState,
...
function canToggleUtilityPanel(overlay) {
  return overlay === "none" || overlay === "quest" || overlay === "backpack" || overlay === "settings";
}
function completeIntervention(setGameState) {
  setGameState((previous) => ({
    ...previous,
    questStage: "complete",
    completedCaseIds: previous.completedCaseIds.includes(previous.currentCaseId) ? previous.completedCaseIds : [...previous.completedCaseIds, previous.currentCaseId],
...
function getNextPosition(position, input, delta, moveSpeed) {
  let dx = 0;
  let dy = 0;
  if (input.up) {
    dy -= 1;
...
function getNearbyCharacter(state) {
  return characters.find((character) => {
    ...
    return distanceInPixels(
      ...
      (characterState == null ? void 0 : characterState.position) ?? character.position
    ) < INTERACT_DISTANCE;
  });
}
...
function getNearbyCaseOwner(state) {
  ...
  const ownerPosition = (ownerState == null ? void 0 : ownerState.position) ?? owner.position;
  return distanceInPixels(state.player.position, ownerPosition) < INTERACT_DISTANCE ? owner : null;
}
function getCaseTransition(state, targetSceneId) {
  if (targetSceneId === "sales" && state.completedCaseIds.includes("onboarding") && state.currentCaseId !== "sales") {
    return {
      currentCaseId: "sales",
      questStage: "briefing",
      diagnosisId: null,
      ...
      toast: {
        id: Date.now(),
        message: "New case started: investigate why demos are not converting into qualified next steps."
      }
    };
  }
  return {};
...
function moveCharacters(state, delta) {
  ...
  for (const character of characters) {
    ...
    const current = nextStates[character.id] ?? {
      ...
      patrolIndex: 0,
      isMoving: false,
      pauseUntil: getCharacterPauseUntil$1(character.id, 0)
    };
    if (!patrol || patrol.length < 2 || character.sceneId !== state.player.sceneId) {
      nextStates[character.id] = { ...current, isMoving: false };
      continue;
    }
    if (distanceInPixels(state.player.position, current.position) < INTERACT_DISTANCE + 22) {
...
function faceCharacterTowardPlayer(state, characterId) {
...
function getDirection(previous, next) {
...
function ArtifactsPanel({
  ...
  const collected = evidenceItems.filter(
    (item) => collectedEvidenceIds.includes(item.id)
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-mini-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: currentCaseLabel }),
          ...
          completedCaseIds.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-mini-section", children: [
            ...
            completedCaseIds.map((caseId) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: earnedArtifactsByCase[caseId].title
              },
              caseId
            ))
          ] })
...
function EvidenceNoteCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "eq-artifact-card", children: [
...
function DialoguePanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-dialogue-speaker", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: character.role }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: character.name })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-dialogue-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "eq-keyboard-hint", children: [
            "Press ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { children: "E" }),
            ", ",
...
function MobileControls({
  ...
  const [stick, setStick] = reactExports.useState({ x: 0, y: 0, active: false });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-mobile-controls pointer-events-auto md:hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        "aria-label": "Move",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "eq-touch-interact", type: "button", onClick: onInteract, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Hand, { className: "h-5 w-5" }),
      "Talk or Inspect"
    ] })
  ] });
}
function NotificationToast({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-toast", "aria-live": "polite", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4 text-emerald-300" }),
...
function QuestLog({
  ...
  const activeGuidance = getActiveGuidance(
    currentCaseId,
    questStage,
    caseEvidence.filter((item) => collectedEvidenceIds.includes(item.id)).length,
    caseEvidence.length
  );
  ...
  const [activeGuideIndex, setActiveGuideIndex] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-panel-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "Case Help" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: caseTitles[currentCaseId] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "eq-ghost-button", type: "button", onClick: onClose, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-4 w-4" }),
            "Close"
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "eq-guide-carousel", "aria-label": "Case help steps", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "eq-kicker", children: [
              "Help ",
              activeGuideIndex + 1,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: activeGuide.body })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-guide-carousel-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: "eq-ghost-button",
                ...
                type: "button",
                onClick: () => setActiveGuideIndex((index2) => Math.max(0, index2 - 1)),
                children: "Back"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                type: "button",
                onClick: () => setActiveGuideIndex(
                  (index2) => Math.min(guideCards.length - 1, index2 + 1)
                ),
                children: "Next"
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "eq-step-list", children: steps.map((step, index2) => {
          const done = index2 < currentIndex || questStage === "complete";
          const active = index2 === currentIndex && questStage !== "complete";
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "article",
            {
              className: `eq-step ${active ? "is-active" : ""}`,
              children: [
                done ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Circle, { className: "h-4 w-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: step.title }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: step.description }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { className: "eq-step-outcome", children: [
                    "Done when: ",
                    step.outcome
                  ] })
                ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-mini-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Evidence reviewed" }),
          caseEvidence.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-mini-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Decisions" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "Diagnosis: ",
            (selectedDiagnosis == null ? void 0 : selectedDiagnosis.label) ?? "Not selected"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "Intervention: ",
            (selectedIntervention == null ? void 0 : selectedIntervention.label) ?? "Not selected"
          ] })
        ] })
      ]
    }
...
function getSteps(caseId) {
  ...
  return [
    ...
    },
    {
      ...
      description: "Choose the explanation that connects the whole evidence pattern. The right answer may not be more training.",
      outcome: "The fix choices unlock because your cause explains the evidence."
    },
    {
      id: "design",
      title: "4. Choose the fix",
      description: "Pick the fix that changes daily work, manager reinforcement, and the numbers leaders inspect.",
      outcome: "You earn a case summary that explains the work in plain English."
    },
    {
      id: "complete",
      title: "5. Review the impact",
      description: "Review the case summary. It shows the problem, evidence, decision, fix, and business result.",
      outcome: caseId === "onboarding" ? "Case 02 is available." : "The final reviewer debrief is available."
    }
  ];
}
function getActiveGuidance(caseId, questStage, evidenceCount, evidenceTotal) {
  const room = caseRooms[caseId];
  const stakeholder = caseId === "sales" ? "Leo" : "Maya";
...
function getSimpleExplanation(caseId) {
  if (caseId === "sales") {
...
function getFinishGuidance(caseId, questStage) {
...
function TitleScreen({ onStart }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "eq-title-screen", "aria-label": "Enablement Quest intro", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-title-world", "aria-hidden": "true", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eq-title-building is-operations" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eq-title-path is-horizontal" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eq-title-path is-vertical" }),
...
function createInitialGameState() {
  ...
  return {
    player: {
      ...
      direction: "down",
      isMoving: false,
      sceneId: (qaScene == null ? void 0 : qaScene.sceneId) ?? "lab",
    ...
    questStage: (qaScene == null ? void 0 : qaScene.questStage) ?? "briefing",
    ...
    dialogue: (qaScene == null ? void 0 : qaScene.dialogue) ?? null,
    toast: null
  };
}
function getCharacterPauseUntil(characterId, step) {
  return Date.now() + 700 + getCharacterPauseDuration(characterId, step);
}
function getCharacterPauseDuration(characterId, step) {
  const seed = characterId.split("").reduce((total, character) => total + character.charCodeAt(0), 0);
  return 900 + (seed + step * 397) % 1400;
}
function GameCanvas() {
  ...
  const activeCharacter = reactExports.useMemo(() => {
    ...
    return characters.find(
      (character) => {
        var _a2;
        return character.id === ((_a2 = gameState.dialogue) == null ? void 0 : _a2.characterId);
      }
    ) ?? null;
  }, [gameState.dialogue]);
  const activeEvidence = reactExports.useMemo(
    () => evidenceItems.find((item) => item.id === gameState.activeEvidenceId) ?? null,
    [gameState.activeEvidenceId]
  );
  const currentEvidenceItems = reactExports.useMemo(
    () => evidenceItems.filter((item) => item.caseId === gameState.currentCaseId),
    [gameState.currentCaseId]
  );
  const currentCollectedEvidenceCount = reactExports.useMemo(
    () => currentEvidenceItems.filter(
      (item) => gameState.collectedEvidenceIds.includes(item.id)
    ).length,
    [currentEvidenceItems, gameState.collectedEvidenceIds]
  );
  const currentDiagnosisOptions = reactExports.useMemo(
    () => diagnosisOptions.filter(
      (item) => item.caseId === gameState.currentCaseId
    ),
    [gameState.currentCaseId]
  );
  const currentInterventionOptions = reactExports.useMemo(
  ...
  const closeEvidenceReview = reactExports.useCallback(() => {
    setGameState((previous) => ({
      ...previous,
      activeEvidenceId: null,
      overlay: previous.questStage === "diagnose" ? "decision" : "none",
      toast: previous.questStage === "diagnose" ? {
        id: Date.now(),
        message: "All evidence is saved. Return to Leo to defend the cause and choose the fix."
      } : previous.toast
    }));
  }, []);
  const startMission = reactExports.useCallback(() => {
    setGameState((previous) => ({
      ...previous,
      player: {
        ...previous.player,
  ...
  const advanceDialogue = reactExports.useCallback(() => {
    setGameState((previous) => {
      ...
      const character = characters.find(
        (item) => {
          var _a2;
          return item.id === ((_a2 = previous.dialogue) == null ? void 0 : _a2.characterId);
        }
      );
      if (!character) {
  ...
  reactExports.useEffect(() => {
    const handleDialogueKeys = (event) => {
      const key = event.key.toLowerCase();
      if (gameStateRef.current.overlay === "dialogue" && (key === "e" || key === "enter" || key === " ") && !event.repeat) {
        event.preventDefault();
        advanceDialogue();
      }
    };
  ...
  const chooseDiagnosis = reactExports.useCallback(
    (id) => {
      ...
      setGameState((previous) => ({
        ...
        toast: option.correct ? null : {
          id: Date.now(),
          message: "Not quite. Re-check the evidence pattern before choosing a fix."
        }
      }));
    },
    [currentDiagnosisOptions]
  );
  const chooseIntervention = reactExports.useCallback(
    (id) => {
      ...
      if (!option.correct) {
        setGameState((previous) => ({
          ...
          toast: {
            id: Date.now(),
            message: "That fix does not solve the cause yet. Try again from the evidence pattern."
          }
        }));
        return;
      }
  ...
  const openCanvas = reactExports.useCallback((caseId) => {
    setGameState((previous) => ({
      ...previous,
  ...
  const startSalesCase = reactExports.useCallback(() => {
    setGameState((previous) => ({
      ...previous,
      currentCaseId: "sales",
      ...
      toast: {
        id: Date.now(),
        message: "Case 02 started: talk with Leo and diagnose the sales enablement problem."
      },
      player: {
        ...previous.player,
        hasStarted: true,
      ...
      children: [
        ...
        gameState.overlay === "dialogue" && activeCharacter && gameState.dialogue && /* @__PURE__ */ jsxRuntimeExports.jsx(
          DialoguePanel,
          {
            ...
            line: activeCharacter.dialogue[gameState.questStage][Math.min(
        ...
        gameState.overlay === "quest" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          QuestLog,
          {
            currentCaseId: gameState.currentCaseId,
            questStage: gameState.questStage,
        ...
        gameState.overlay === "backpack" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          ArtifactsPanel,
          {
            collectedEvidenceIds: gameState.collectedEvidenceIds,
            completedCaseIds: gameState.completedCaseIds,
        ...
        gameState.overlay === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          SettingsPanel,
          {
            moveSpeed,
        ...
        gameState.overlay === "evidence" && activeEvidence && /* @__PURE__ */ jsxRuntimeExports.jsx(
          EvidencePanel,
          {
        ...
        gameState.overlay === "decision" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          DecisionPanel,
          {
        ...
        gameState.overlay === "canvas" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          CanvasPanel,
          {
            artifact: gameState.activeCanvasCaseId ? earnedArtifactsByCase[gameState.activeCanvasCaseId] : gameState.earnedArtifact ?? earnedArtifactsByCase[gameState.currentCaseId] ?? earnedCanvas,
            canStartSalesCase: gameState.currentCaseId === "onboarding" && gameState.completedCaseIds.includes("onboarding") && !gameState.completedCaseIds.includes("sales"),
            showFinalDebrief: gameState.currentCaseId === "sales" && gameState.completedCaseIds.includes("onboarding") && gameState.completedCaseIds.includes("sales"),
            onClose: closeOverlay,
            onStartSalesCase: startSalesCase
          }
        ),
        gameState.toast && /* @__PURE__ */ jsxRuntimeExports.jsx(
          NotificationToast,
          {
            toast: gameState.toast,
            onDismiss: () => setGameState((previous) => ({ ...previous, toast: null }))
          }
        )
      ]
    }
...
function CaseBriefingPanel({ onClose }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-start-briefing-mission", "aria-label": "Mission goal", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Help the organization solve the work problem, not just respond to the training request. Follow the evidence, name the cause, choose the enablement response, and explain the business impact." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-start-briefing-grid", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Return to Leo. Choose the cause that explains the whole pattern, then pick the fix that changes behavior and can be measured." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "If you feel lost" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Open Help. It always says what to do now, why it matters, and what counts as done." })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-start-briefing-controls", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Move: arrows, WASD, or joystick" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Talk or inspect: E, Space, Enter, or button" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Help anytime: Q or Help" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "eq-primary-button", type: "button", onClick: onClose, children: "Begin the investigation" })
      ]
    }
  );
}
...
function getQaStageState(caseId, qaStage, qaDiagnosis, qaIntervention) {
  if (qaStage !== "diagnose" && qaStage !== "design") {
    return {};
  }
  const collectedEvidenceIds = evidenceItems.filter((item) => item.caseId === caseId).map((item) => item.id);
  ...
  const diagnosisId = qaDiagnosis === "wrong" ? (wrongDiagnosis == null ? void 0 : wrongDiagnosis.id) ?? null : qaStage === "design" || qaDiagnosis === "correct" ? (correctDiagnosis == null ? void 0 : correctDiagnosis.id) ?? null : null;
...
function EvidencePanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "eq-panel-header", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "Evidence Reviewed" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: evidence.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "Evidence ",
            evidenceIndex + 1,
            " of ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "eq-evidence-main-read", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: evidence.summary }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "What it may mean" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: evidence.insight })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-evidence-check", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          checkOptions.map((option, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                selectedSignal === option.kind && /* @__PURE__ */ jsxRuntimeExports.jsx("small", { children: option.feedback })
              ]
            },
            option.kind
          ))
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-panel-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "Settings" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Play Options" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Adjust movement without changing the case." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "eq-ghost-button", type: "button", onClick: onClose, children: "Close" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "eq-setting-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Movement speed" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-mini-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Controls" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Desktop: WASD or arrow keys to move. E, Space, or Enter to talk or inspect." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Mobile: use the joystick and Talk or Inspect button." })
        ] })
      ]
    }
  );
...
function DecisionPanel({
  diagnosisOptions: diagnosisOptions2,
  interventionOptions: interventionOptions2,
  diagnosisId,
  interventionId,
  currentCaseId,
  onChooseDiagnosis,
  ...
  const selectedDiagnosis = diagnosisOptions2.find(
    (option) => option.id === diagnosisId
  );
  const selectedIntervention = interventionOptions2.find(
    (option) => option.id === interventionId
  );
  const canChooseIntervention = (selectedDiagnosis == null ? void 0 : selectedDiagnosis.correct) ?? false;
  const synthesis = caseSynthesis[currentCaseId];
  const [decisionStep, setDecisionStep] = reactExports.useState(
  ...
  const visibleOptions = isFixStep ? interventionOptions2 : diagnosisOptions2;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-panel-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "Make the Recommendation" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: isFixStep ? "Pick the practical fix" : synthesis.question }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: isFixStep ? "Now choose the support that changes the work and can be measured." : "Choose the cause that best explains the evidence." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "eq-ghost-button", type: "button", onClick: onClose, children: "Close" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-decision-brief", "aria-label": "Decision hint", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isFixStep ? synthesis.metric : synthesis.pattern })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "eq-decision-options", children: visibleOptions.map((option) => {
          const selected = isFixStep ? interventionId === option.id : diagnosisId === option.id;
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              disabled,
              type: "button",
              onClick: () => isFixStep ? onChooseIntervention(option.id) : onChooseDiagnosis(option.id),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: option.label }),
                selected && /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { children: [
                  option.explanation,
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "eq-choice-consequence", children: isFixStep ? `Tradeoff: ${option.tradeoff}` : `Evidence check: ${option.evidenceHint}` })
                ] })
              ]
            },
            option.id
...
function DecisionCoach({
  ...
  if (!selectedDiagnosis) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-decision-coach", "aria-label": "Decision coaching", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "How to decide" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Imagine you are in a stakeholder meeting. Pick the answer you could defend with evidence, not the one that sounds easiest to build." })
    ] });
  }
  if (!canChooseIntervention) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Re-check the evidence" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "This answer misses part of the system. Before choosing a fix, make sure the cause explains every evidence item, not just the loudest request." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { children: [
            "Lesson: ",
            selectedDiagnosis.learningTakeaway
          ] })
        ]
      }
    );
  ...
  if (!selectedIntervention) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "aside",
      {
        ...
        "aria-label": "Decision coaching",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Good diagnosis" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Now choose the fix that changes the work, reinforces the behavior, and gives leaders a useful metric." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { children: [
            "Lesson: ",
            selectedDiagnosis.learningTakeaway
          ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "aside",
    {
      ...
      "aria-label": "Decision coaching",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: selectedIntervention.correct ? "Strong fix" : "Not enough yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: selectedIntervention.correct ? "This fix fits the evidence and connects enablement work to a business signal." : "This fix leaves at least one important evidence item unresolved." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("small", { children: [
          "Lesson: ",
          selectedIntervention.learningTakeaway
        ] })
      ]
    }
  );
...
const caseSynthesis = {
  onboarding: {
    ...
    prompt: "Leadership asked for more training. Your job is to decide whether the evidence supports that request or points somewhere else.",
    pattern: "Your answer must explain conflicting instructions, delayed access, and a support-ticket spike after orientation.",
...
function CanvasPanel({
  ...
  const showCompletionProof = showFinalDebrief || artifact.id === "sales-enablement-impact-canvas";
  const summaryCards = [
    {
      label: "1 of 4",
      title: "Request",
  ...
  const [summaryIndex, setSummaryIndex] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "eq-summary-step", "aria-label": "Case summary step", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: activeSummary.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: activeSummary.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: activeSummary.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-summary-step-actions", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                className: "eq-ghost-button",
                ...
                type: "button",
                onClick: () => setSummaryIndex((index2) => Math.max(0, index2 - 1)),
                children: "Back"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                type: "button",
                onClick: () => setSummaryIndex(
                  (index2) => Math.min(summaryCards.length - 1, index2 + 1)
                ),
                children: "Next"
              }
            )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(SummaryBridge, { artifact }),
        canStartSalesCase && /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-next-case", "aria-label": "Next case", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "Next case" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Ready for the sales enablement version?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Case 01 proves performance-consulting judgment. Case 02 applies the same pattern to revenue behavior: discovery quality, manager coaching, and pipeline impact." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "Start Case 02: Sales Enablement"
            }
          )
        ] }),
        showCompletionProof && /* @__PURE__ */ jsxRuntimeExports.jsx(FinalReviewerDebrief, {})
      ]
    }
  );
}
function SummaryBridge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-summary-bridge", "aria-label": "What you practiced", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "What you practiced" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Decision loop completed" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { children: ((debrief == null ? void 0 : debrief.points) ?? []).map((point) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: point.label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: point.value })
    ] }, point.label)) })
  ] });
}
function getArtifactSection(artifact, label) {
  var _a;
  return ((_a = artifact.sections.find((section) => section.label === label)) == null ? void 0 : _a.value) ?? "Not captured yet.";
}
function FinalReviewerDebrief() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "eq-final-debrief", "aria-label": "Facilitator debrief", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eq-kicker", children: "Facilitator debrief" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Diagnose before designing." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "eq-final-debrief-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "What changed?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "The learner questioned the request before choosing a solution." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "What made it work?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Evidence pointed to behavior, workflow, coaching, and measurement." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Try this next" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Pick one real request and ask: what evidence would prove the actual cause?" })
      ] })
    ] })
  ] });
}

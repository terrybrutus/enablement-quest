...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    tilePatches: [
      tilePatch("north-sidewalk", 3, 5.8, 24, 2, tileSprites.path),
      tilePatch("south-sidewalk", 8, 13.6, 14, 2, tileSprites.path),
      tilePatch("west-path", 6.7, 5.8, 2, 7.8, tileSprites.path),
      tilePatch("east-path", 21.3, 5.8, 2, 7.8, tileSprites.path),
      tilePatch("center-plaza", 9.8, 7, 10.4, 5.5, tileSprites.path),
      tilePatch("plaza-north-lawn", 11.8, 7.45, 6.4, 0.7, tileSprites.path),
      tilePatch("plaza-south-lawn", 11.6, 11.2, 6.8, 0.8, tileSprites.path),
      tilePatch("lab-walk", 14, 11.9, 2, 4.2, tileSprites.path),
      tilePatch("sales-walk", 6.6, 4.9, 2.4, 2.8, tileSprites.doorway),
      tilePatch("ops-walk", 21, 4.9, 2.4, 2.8, tileSprites.doorway),
      tilePatch("lab-threshold", 13.8, 15.75, 2.4, 1.25, tileSprites.doorway),
      tilePatch(
        "garden-bed-left",
        7.9,
        9.15,
      ...
      tilePatch("hedge-left", 7.9, 8.65, 2.4, 0.6, tileSprites.hedge),
      tilePatch("hedge-right", 19.7, 8.65, 2.4, 0.6, tileSprites.hedge),
      tilePatch("plaza-hedge-north", 11.2, 7, 7.6, 0.6, tileSprites.hedge),
      tilePatch("plaza-hedge-south", 11.2, 11.8, 7.6, 0.6, tileSprites.hedge),
    ],
    portals: [
      {
        id: "hub-to-lab",
        label: "Learning Systems Lab",
        rect: { x: 14, y: 15.75, width: 2, height: 1.25 },
        targetSceneId: "lab",
      ...
      },
      {
        ...
        rect: { x: 20.4, y: 4.8, width: 3.4, height: 2.3 },
      ...
      },
      {
        ...
        rect: { x: 6, y: 4.8, width: 3.4, height: 2.3 },
        targetSceneId: "sales",
        targetPosition: { x: 9, y: 9.35 },
      },
    ],
    blocks: [
      { x: 19.4, y: 0.9, width: 7.2, height: 4 },
      { x: 3.4, y: 0.9, width: 7.2, height: 4 },
      { x: 12.45, y: 15, width: 5.1, height: 2.25 },
    ...
    props: [
      ...
      },
      {
        ...
        size: { width: 5.1, height: 2.95 },
        sprite: gardenSprite(0, 3904, 704, 544),
        collision: true,
      },
      {
        id: "lab-door",
        position: { x: 14.05, y: 16.65 },

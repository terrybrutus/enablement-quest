...
export const scenes: Scene[] = [
  ...
  },
  {
    ...
    tilePatches: [
      tilePatch("north-sidewalk", 3, 6.35, 24, 2, tileSprites.path),
      tilePatch("south-sidewalk", 8, 13.6, 14, 2, tileSprites.path),
      tilePatch("west-path", 6.7, 6.35, 2, 7.25, tileSprites.path),
      tilePatch("east-path", 21.3, 6.35, 2, 7.25, tileSprites.path),
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        position: { x: 12.2, y: 8.35 },
        size: { width: 3, height: 1.1 },
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        position: { x: 12.1, y: 8.3 },
        size: { width: 3.1, height: 1.1 },
        sprite: officeSprite(384, 2004, 192, 60),
        collision: true,
      },
    ],
